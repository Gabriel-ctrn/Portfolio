    ...
    <div className="min-h-screen bg-dark-bg text-cream">
      ...
      <div className="relative overflow-hidden min-h-[600px] lg:min-h-[500px]">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://cdn.builder.io/api/v1/image/assets%2Fcf447869b8b140b8b928bf509f57b9d7%2F63cf970849ff41ba93849b356c120ab9?format=webp&width=800')`
          }}
        ></div>
            ...
            {!showFinalMessage ? (
              ...
              <div className={`transition-opacity duration-1000 ${animationComplete ? 'opacity-0' : 'opacity-100'}`}>
                {displayLines.map((line, index) => (
                  <div key={index} className={`mb-2 transition-opacity duration-300 ${index <= currentLineIndex ? 'opacity-100' : 'opacity-30'}`}>
                    <span className="text-green-terminal">{line.prompt}</span>
                    <span className="text-cream">
                      {line.completed ? line.content : line.currentText}
                      {index === currentLineIndex && !line.completed && showCursor && (
              ...
              // Final Message
              <div className="opacity-0" style={{ animation: 'fadeIn 1.5s ease-in-out 0.3s forwards' }}>
                <div className="text-cream text-center lg:text-left leading-relaxed">
                  Olá! meu nome é <span className="text-teal-accent font-semibold">J Gabriel</span>, sou um{' '}
                  <span className="text-teal-accent font-semibold">Desenvolvedor Web</span> e estudante de{' '}
                  <span className="text-teal-accent font-semibold">Ciência da Computação</span>.
                </div>
              </div>
            )}
          </div>
      ...
      <div className="px-4 lg:px-[149px] mt-[50px] lg:mt-[75px] mb-[50px] lg:mb-[75px]">
        <h2 className="text-2xl lg:text-[32px] font-sans text-cream mb-[50px] lg:mb-[77px]">Principais Skills</h2>
      ...
      <div className="px-4 lg:px-[149px] mt-[50px] lg:mt-[75px] mb-[50px] lg:mb-[100px]">
        <h2 className="text-2xl lg:text-[32px] font-sans text-cream mb-[50px] lg:mb-[77px]">Principais projetos</h2>

        <div className="relative">
          {/* Project Cards with Integrated Circular Backgrounds */}
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-[75px] justify-center relative">
            {/* Project Card 1 */}
            <div className="relative w-full lg:w-[263px] h-[200px] lg:h-[263px] flex items-end justify-center">
              {/* Circular gradient background */}
              <div className="absolute inset-0 w-full h-full rounded-full bg-gradient-to-br from-teal-accent via-teal-accent/50 to-transparent"></div>
              {/* Rectangular card content */}
              <div className="relative w-full lg:w-[218px] h-[200px] lg:h-[242px] rounded-[19px] bg-project-card p-6 flex flex-col justify-end">
                <h3 className="text-cream text-xl mb-2">Lorem ipsum</h3>
              </div>
            </div>
            ...
            <div className="relative w-full lg:w-[263px] h-[200px] lg:h-[263px] flex items-end justify-center">
              ...
              <div className="absolute inset-0 w-full h-full rounded-full bg-gradient-to-br from-teal-accent via-teal-accent/50 to-transparent"></div>
              {/* Rectangular card content */}
              <div className="relative w-full lg:w-[218px] h-[200px] lg:h-[242px] rounded-[19px] bg-project-card-light p-6 flex flex-col justify-end">
                <h3 className="text-cream/55 text-xl mb-2">Lorem ipsum</h3>
              </div>
            </div>
        ...
        <div className="mt-[60px] lg:mt-[109px] max-w-[903px] mx-auto px-4 lg:px-0">
          <p className="text-cream text-lg lg:text-2xl leading-relaxed text-center">
        ...
        <div className="mt-[24px] lg:mt-[36px] text-center">
          <p className="text-cream text-lg lg:text-xl break-words">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-8 px-4">
          ...
          <div className="flex flex-row lg:flex-col gap-4">
            <div className="w-[60px] h-[60px] lg:w-[79px] lg:h-[79px] rounded-full bg-gradient-to-br from-teal-primary to-transparent flex items-center justify-center">
              <span className="text-teal-secondary text-xl lg:text-2xl">📧</span>
            </div>
            <div className="w-[44px] h-[44px] rounded-full bg-gradient-to-br from-teal-primary to-transparent flex items-center justify-center">
              <span className="text-teal-secondary text-lg lg:text-xl">📱</span>
            </div>
            <div className="w-[44px] h-[44px] rounded-full bg-gradient-to-br from-teal-primary to-transparent flex items-center justify-center">
              <span className="text-teal-secondary text-lg lg:text-xl">🐙</span>
            </div>
          ...
          <div className="text-cream text-center lg:text-left">
            <div className="text-lg lg:text-xl mb-2 lg:mb-3 break-words">jayme.gabriel@gmail.com</div>
            <div className="text-lg lg:text-xl mb-2 lg:mb-3">(87) 91205-8745</div>
            <div className="text-lg lg:text-xl break-words">github.com/jgabirel</div>
          </div>
        </div>
      </footer>
    </div>
